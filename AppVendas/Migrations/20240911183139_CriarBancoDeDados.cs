        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataVnda = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Venda = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProdutoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QuantidadeVendida = table.Column<double>(type: "float", nullable: false),
                    ValorTotalDoItem = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntensDaVendas", x => x.ItemDaVendaId);
                    table.ForeignKey(
                        name: "FK_IntensDaVendas_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntensDaVendas_ProdutoId",
                table: "IntensDaVendas",
                column: "ProdutoId");
