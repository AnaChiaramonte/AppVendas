...
namespace AppVendas.Controllers
{
    public class ItemDaVendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemDaVendaId,VendaId,Venda,ProdutoId,QuantidadeVendida,ValorTotalDoItem")] ItemDaVenda itemDaVenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ItemDaVendaId,VendaId,Venda,ProdutoId,QuantidadeVendida,ValorTotalDoItem")] ItemDaVenda itemDaVenda)
        {
